...
const char *opt_AAyaw[] = { "Off", "Manual", "Backwards", "Spin", "Lagspin", "Flip", "Side", "Jitter" };
const char *opt_AAair[] = { "Off", "Manual", "Backwards", "Spin", "Lagspin", "Flip", "Side", "Jitter", "Backspin" };
