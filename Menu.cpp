	...
	void hvhTab() {
		...
		ImGui::NextColumn();
		{
			...
			ImGui::BeginChild("COL2", ImVec2(0, 0), true);
			{
				...
				ImGui::Text("Real Yaw");
				ImGui::Combo("##AAY", &g_Options.hvh_antiaim_y, opt_AAyaw, 8);
				ImGui::Text("Real Yaw Air");
				ImGui::Combo("##AAA", &g_Options.hvh_antiaim_y_air, opt_AAair, 9);
				ImGui::Text("Fake Yaw");
				ImGui::Combo("##FAAY", &g_Options.hvh_antiaim_y_fake, opt_AAair, 9);
